...
async def benchmark(
    ...
    if profile:
        ...
        logger.info(f"Profiler endpoint: {base_url + '/start_profile'}")
        logger.info(f"Profiler input: {test_prompt}")
        logger.info(f"Profiler input length: {test_prompt_len}")
        logger.info(f"Profiler output length: {test_output_len}")
        logger.info(f"Profiler logprobs: {logprobs}")
        logger.info(f"Profiler multi modal content: {test_mm_content}")
        logger.info(f"Profiler ignore eos: {ignore_eos}")
        logger.info(f"Profiler extra body: {extra_body}")
        ...
        print(f"Profiler output: {profile_output}")
        if profile_output.success:
            logger.info("Profiler started")
        else:
            logger.warning(f"Profiler failed to start: {profile_output.error}")
    ...
    if profile:
        ...
        if profile_output.success:
            ...
            logger.warning(f"Profiler failed to stop: {profile_output.error}")
